...
<template>
  <main v-if="initialized" class="h-max">
    ...
    <RouterLink to="/" class="p-4 rounded-t-lg bg-teal-200 dark:bg-teal-900 text-slate-600 dark:text-slate-300">Trains</RouterLink>
    <RouterLink to="/stations" class="p-4 rounded-t-lg bg-teal-200 dark:bg-teal-900 text-slate-600 dark:text-slate-300">Stations</RouterLink>
    <RouterView />
